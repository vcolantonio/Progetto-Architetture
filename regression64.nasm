...
popola:
	...
	fork:		
			...
			VMOVAPD	YMM1, [R10 + RAX]	; YMM1 = input->x[(oss ... oss+p-1) + j_i*n];
			VMULPD	YMM0,YMM1			; num1=num1* input->x[(oss ... oss+p-1) + j_i*n];
			
			VMOVAPD	YMM3, [R10 + RAX + 32]	; YMM3 = input->x[(oss ... oss+p-1) + j_i*n];
			VMULPD	YMM2,YMM3			; num2=num2* input->x[(oss ... oss+p-1) + j_i*n];
			
			VMOVAPD	YMM5, [R10 + RAX + 64]	; YMM5 = input->x[(oss ... oss+p-1) + j_i*n];
			VMULPD	YMM4,YMM5			; num3=num3* input->x[(oss ... oss+p-1) + j_i*n];
			
			VMOVAPD	YMM7, [R10 + RAX + 96]	; YMM7 = input->x[(oss ... oss+p-1) + j_i*n];
			...
			VMOVAPD	[R11 + RAX], YMM0		; xast[(oss ... oss+p-1)+coldest*n]=num1;
			VMOVAPD	[R11 + RAX + 32], YMM2	; xast[(oss+p ... oss+2p-1)+coldest*n]=num2;
			VMOVAPD	[R11 + RAX + 64], YMM4	; xast[(oss+2p ... oss+3p-1)+coldest*n]=num3;
			VMOVAPD	[R11 + RAX + 96], YMM6	; xast[(oss+3p ... oss+4p-1)+coldest*n]=num4;
